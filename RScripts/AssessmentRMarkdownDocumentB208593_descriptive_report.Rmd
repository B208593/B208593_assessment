...
```{r h,message = FALSE, warning = FALSE, echo=FALSE, results='hide'}
data(ae_attendances)
ae<-ae_attendances
class(ae)
```
...
```{r o,message = FALSE, warning = FALSE, echo=FALSE}
ae<- ae %>%
...
```{r s,message = FALSE, warning = FALSE, echo=FALSE, results='hide'}
ae2 %>%
...
```{r pr,message = FALSE, warning = FALSE, echo=FALSE}

---
title: '**Working with data types and structures in Python and R: Assessment R Markdown
  Document**'
author: "B208593"
...
### **Visualise perfomance**
```{r r22,message = FALSE, warning = FALSE}
type1_performance <- ae2 %>%
  group_by(period) %>%
...
```{r r23,message = FALSE, warning = FALSE}
ggplot(type1_performance, aes(period, performance)) +
  ...
  labs(x = "Month of attendance",
       ...
       title = "NHS type 1 accident and emergency (A&E) four hour performance",
...
```{r pr,message = FALSE, warning = FALSE}
trainIndex <- createDataPartition(ae2$index, p = prop, 
                                  list = FALSE, 
                                  times = 1)
```

```{r trainindex,message = FALSE, warning = FALSE}
...
```{r testmarker,message = FALSE, warning = FALSE}
...
```{r datac,message = FALSE, warning = FALSE}
...
```{r data5,message = FALSE, warning = FALSE}
...
```{r variable_description,message = FALSE, warning = FALSE}
...
```{r glimpse3,message = FALSE, warning = FALSE}
...
```{r variable_type,message = FALSE, warning = FALSE}
...
```{r build_linker,message = FALSE, warning = FALSE}
...
```{r main_string,message = FALSE, warning = FALSE}
...
```{r save_it,message = FALSE, warning = FALSE}
